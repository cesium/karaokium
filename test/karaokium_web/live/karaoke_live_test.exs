defmodule KaraokiumWeb.KaraokeLiveTest do
  ...
  @create_attrs %{
    end_date: %{day: 15, hour: 2, minute: 49, month: 4, year: 2022},
    name: "some name",
    start_date: %{day: 15, hour: 2, minute: 49, month: 4, year: 2022}
  }
  @update_attrs %{
    end_date: %{day: 16, hour: 2, minute: 49, month: 4, year: 2022},
    name: "some updated name",
    start_date: %{day: 16, hour: 2, minute: 49, month: 4, year: 2022}
  }
  @invalid_attrs %{
    end_date: %{day: 30, hour: 2, minute: 49, month: 2, year: 2022},
    name: nil,
    start_date: %{day: 30, hour: 2, minute: 49, month: 2, year: 2022}
  }
